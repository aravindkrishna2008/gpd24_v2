...
distorted_img_filename = 'chessboard_input1.jpg'
...
def main():
    ...
    optimal_camera_matrix, roi = cv2.getOptimalNewCameraMatrix(mtx, dist,
                                                               ...
                                                               1,
                                                               (width, height))
    np.save('optimal_camera_matrix.npy', optimal_camera_matrix)
    np.save('mtx.npy', mtx)
    ...
    # Close all windows
    print(type(optimal_camera_matrix))
    print(type(mtx))
    print(type(dist))
    cv2.destroyAllWindows()

    with open('optimal_camera_matrix.pickle', 'wb') as file:
        # Serialize and write the variable to the file
        pickle.dump(optimal_camera_matrix, file)
    with open('mtx.pickle', 'wb') as file:
        # Serialize and write the variable to the file
        pickle.dump(mtx, file)
    with open('dist.pickle', 'wb') as file:
        # Serialize and write the variable to the file
